...
router.get('/getUser', verifyToken, async (req, res, next) => await getUser(req, res, pool, next))
router.get('/getAdmin', verifyToken, async (req, res, next) => await getAdmin(req, res, pool, next))
