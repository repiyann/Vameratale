...
import { createSize, getSizes, getSizeByID, updateSize, deleteSize } from '../../../controllers/admin/size/size.controller.js'
...
router.get('/getSize/:id', async (req, res, next) => await getSizeByID(req, res, pool, next))
