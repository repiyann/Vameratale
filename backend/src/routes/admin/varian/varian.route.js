...
import { createVarians, getVarians, getVarianByID, updateVarian, deleteVarian } from '../../../controllers/admin/varian/varian.controller.js'
...
router.get('/getVarian/:id', async (req, res, next) => await getVarianByID(req, res, pool, next))
